                ...
                if (value != null) {
                    ...
                    for (int i : rows) {
                        ...
                        if (value.getDtevento() != null)
                            agenda.setDtevento(value.getDtevento());
                        if (value.getDescricao() != null)
                            agenda.setDescricao(value.getDescricao());
                        if (value.getDtevento() != null || value.getDescricao() != null)
                        getTableModel().updateRow(agenda);
                    }
                    } catch (Exception e) {
                        getLogger().error(e.getMessage(), e);
